...
def main() -> None:
    parser = argparse.ArgumentParser(description='Build a context bundle for the next AFPSNN task.')
    parser.add_argument('--state', default='STATE.md', help='Path to STATE.md YAML file')
    parser.add_argument('--impact', help='Path to impact JSON file (from impact_map.py)')
